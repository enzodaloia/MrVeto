 ...
 */
final class Version20260217155055 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP token, DROP img, DROP longitude, DROP latitude, DROP created_at');
    }
}
