...
final class HoraireController extends AbstractController
{
    ...
    #[Route('/{slug}', name: 'app_horaire_show', methods: ['GET'])]
    public function show(#[MapEntity(mapping: ['slug' => 'slug'])] Horaire $horaire): Response
    {
    ...
    #[Route('/{slug}/edit', name: 'app_horaire_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, #[MapEntity(mapping: ['slug' => 'slug'])] Horaire $horaire, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(HoraireType::class, $horaire);
        $form->handleRequest($request);
    ...
    #[Route('/{slug}', name: 'app_horaire_delete', methods: ['POST'])]
    public function delete(Request $request, #[MapEntity(mapping: ['slug' => 'slug'])] Horaire $horaire, EntityManagerInterface $entityManager): Response
    {
